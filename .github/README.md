...
- base:
  - git base-devel neovim terminator yadm zsh etckeeper podman podman-compose podlet qemu-full virt-manager nvidia-settings firefox syncthing nvidia-container-toolkit pamixer
